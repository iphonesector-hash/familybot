...
export default function GamesPage(){
  ...
  return <main className={styles.page}>
    ...
    <div className={styles.title}><h2>بازی‌های گروهی</h2><span>۲ بازی فعال</span></div>
    <section className={styles.gameGrid}>
      ...
      {[["🏁","مسابقه سرعت"],["📝","اسم‌فامیل"],["🎭","مافیا Lite"],["❓","۲۰ سؤال"]].map(([icon,name])=><article className={styles.game} key={name}><span className={styles.gameIcon}>{icon}</span><h3>{name}</h3><p>گروهی · موتور مستقل لازم دارد</p><b>در حال توسعه</b></article>)}
    </section>
