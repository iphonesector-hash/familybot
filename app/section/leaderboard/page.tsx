...
export default function LeaderboardPage(){
  ...
  return <main className="appShell"><div className="ambient ambientA"/><div className="starField"/><header className="appHeader"><a href="/" className="roundButton">←</a><div className="wordmark"><b>پروفایل و رتبه</b><span>۵ نفر اول خانواده</span></div><a href="/section/achievements" aria-label="دستاوردها" title="دستاوردها"><IconOrb name="trophy" tone="gold"/></a></header>
  ...
  <nav aria-label="امکانات پروفایل" style={{display:"flex",flexWrap:"wrap",gap:8,marginTop:14}}><a className="ghostCta" href="/section/achievements">دستاوردها</a><a className="ghostCta" href="/section/community">اجتماع خانواده</a><a className="ghostCta" href="/section/family">خانواده و ابزارها</a></nav>
