...
export function openMiniAppKeyboard(){const url=process.env.NEXT_PUBLIC_APP_URL||DEFAULT_APP_URL;return{inline_keyboard:[[{text:"🏠 باز کردن JAHANI",web_app:{url}}],[{text:"🐾 سگول",web_app:{url:new URL('/section/sagool',url).toString()}},{text:"👤 پروفایل",callback_data:"menu:profile"}]]}}
...
export function mainMenuKeyboard(_canManage=false){const base=process.env.NEXT_PUBLIC_APP_URL||DEFAULT_APP_URL;const b=(p:string,t:string)=>webAppButton(base,p,t);return{inline_keyboard:[
[b("/","🏠 Mini App")],[b("/section/sagool","🐾 سگول"),b("/section/family","👨‍👩‍👧‍👦 خانواده")],[b("/section/tree","🌳 شجره‌نامه"),b("/section/planner","📅 برنامه‌ریز")],[b("/section/wheel","🎡 گردونه"),b("/section/store","🛍 فروشگاه")],[b("/section/fund","🏦 صندوق"),b("/section/finance","💳 بانک و حساب")],[b("/section/memories","🖼 خاطرات"),b("/section/legacy","📖 خانواده ما")],[b("/section/fun","🎭 سرگرمی و دزفولی")],[b("/section/achievements","🏅 دستاوردها"),{text:"🎮 بازی‌ها",callback_data:"menu:games"}],[b("/section/community","🌍 چالش‌ها"),b("/section/tools","🧰 کاربردی")],[b("/ai","🤖 سکتور AI"),{text:"👤 پروفایل",callback_data:"menu:profile"}],[{text:"🏆 رتبه‌بندی",callback_data:"menu:rank"},{text:"🎁 جایزه روزانه",callback_data:"menu:daily"}],[{text:"🛡 مدیریت و تنظیمات گروه",callback_data:"menu:admin"}],[{text:"📜 قوانین",callback_data:"menu:rules"},{text:"❓ راهنما",callback_data:"menu:help"}]
]}}
