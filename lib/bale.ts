...
export function openMiniAppKeyboard(){const url=process.env.NEXT_PUBLIC_APP_URL;if(!url)return undefined;return{inline_keyboard:[[{text:"🏠 باز کردن Family Bot",web_app:{url}}],[{text:"🎮 بازی‌ها",callback_data:"menu:games"},{text:"👤 پروفایل",callback_data:"menu:profile"}]]}}
...
export function mainMenuKeyboard(canManage=false){const base=process.env.NEXT_PUBLIC_APP_URL;const financeButton=webAppButton(base,"/section/finance","💳 حساب خانواده"),communityButton=webAppButton(base,"/section/community","🌍 چالش و سفر"),secretGiftButton=webAppButton(base,"/section/secret-gift","🎁 Secret Gift"),funButton=webAppButton(base,"/section/fun","😄 سرگرمی خانواده"),toolsButton=webAppButton(base,"/section/tools","🧰 ابزارهای کاربردی"),wheelButton=webAppButton(base,"/section/wheel","🎡 گردونه شانس"),fundButton=webAppButton(base,"/section/fund","🏦 صندوق خانوادگی"),treeButton=webAppButton(base,"/section/tree","🌳 شجره‌نامه");const rows:BaleInlineButton[][]=[[{text:"🏠 Mini App",callback_data:"menu:miniapp"}],[{text:"👨‍👩‍👧‍👦 خانواده",callback_data:"menu:family"},treeButton],[{text:"📅 برنامه‌ریز",callback_data:"menu:planner"},wheelButton],[fundButton,financeButton],[{text:"🖼 خاطرات",callback_data:"menu:memories"},communityButton],[secretGiftButton,{text:"🛍 فروشگاه",callback_data:"menu:store"}],[{text:"🏅 دستاوردها",callback_data:"menu:achievements"},{text:"🎮 بازی‌ها",callback_data:"menu:games"}],[funButton,toolsButton],[{text:"🤖 Family AI",callback_data:"menu:ai"},{text:"👤 پروفایل",callback_data:"menu:profile"}],[{text:"🏆 رتبه‌بندی",callback_data:"menu:rank"},{text:"🎁 جایزه روزانه",callback_data:"menu:daily"}],[{text:"📜 قوانین",callback_data:"menu:rules"},{text:"❓ راهنما",callback_data:"menu:help"}]];if(canManage)rows.push([{text:"🛡 مدیریت گروه",callback_data:"menu:admin"}]);return{inline_keyboard:rows}}
