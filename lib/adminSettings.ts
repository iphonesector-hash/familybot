...
const columns="anti_flood,anti_link,lock_photo,lock_video,lock_document,lock_forward,lock_sticker,lock_gif,lock_voice,lock_audio,lock_text,flood_limit,flood_window_seconds,flood_mute_minutes,warn_limit,welcome_enabled,welcome_message";
